...
# get data from user
# syncInterval    = input("What is the synchronization interval? ")
...
syncInterval    = 5
logPath         = 'C:/Users/astra/Documents/Work/Blockchain/Python/Source folder to clone folder copy and update app/log.txt'
originalPath    = 'C:\\Users\\astra\\Documents\\Work\\Blockchain\\Python\\Source folder to clone folder copy and update app\\original'
replicaPath     = 'C:/Users/astra/Documents/Work/Blockchain/Python/Source folder to clone folder copy and update app/clone'
